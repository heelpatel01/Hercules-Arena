...
export const Home: React.FC<HomeProps> = ({ onBookNow }) => {
  return (
    <div className="space-y-0 pb-12">
      ...
      <div className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-20 pb-20 md:pt-20 md:pb-0">
          <div className="max-w-4xl">
            ...
            <div className="inline-flex items-center gap-2 bg-turf-500/10 border border-turf-500/20 rounded-full px-4 py-1.5 mb-6 md:mb-8 backdrop-blur-md">
              ...
              <span className="text-turf-400 text-[10px] md:text-xs font-bold tracking-wider uppercase">
                Open 24/7 • Night Lights Enabled
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
              <Button
                onClick={onBookNow}
                className="w-full sm:w-auto h-14 px-8 text-lg rounded-full shadow-[0_0_40px_rgba(34,197,94,0.3)] hover:shadow-[0_0_60px_rgba(34,197,94,0.5)] transition-all duration-300 transform hover:-translate-y-1"
              >
                Book Slot Now
              ...
              <div className="w-full sm:w-auto flex items-center gap-4 px-6 py-4 bg-white/5 rounded-full border border-white/10 backdrop-blur-sm">
                <div className="flex -space-x-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-8 h-8 rounded-full bg-zinc-800 border-2 border-black flex items-center justify-center text-[10px] text-zinc-500"
                    >
                ...
                <div className="text-sm">
                  ...
                  <p className="text-zinc-500 text-xs leading-none mt-1">
                    Trusted Community
                  </p>
                </div>
              </div>
        ...
        <div className="absolute bottom-0 w-full border-t border-white/10 bg-black/80 backdrop-blur-md overflow-hidden py-4">
          <div className="max-w-7xl mx-auto px-4 flex justify-between items-center text-zinc-400 text-sm font-medium tracking-widest uppercase">
            {/* Marquee for mobile/tablet, static for desktop */}
            <div className="block md:hidden w-full overflow-x-hidden">
              <div
                className="marquee flex gap-8 opacity-80 whitespace-nowrap"
                style={{ animation: "marquee-right 18s linear infinite" }}
              >
                <span className="flex items-center gap-2 flex-shrink-0">
                  <Trophy className="w-4 h-4 text-turf-500" /> Tournament Grade
                  Turf
                </span>
                <span className="flex items-center gap-2 flex-shrink-0">
                  <Zap className="w-4 h-4 text-turf-500" /> 1000W Floodlights
                </span>
                <span className="flex items-center gap-2 flex-shrink-0">
                  <Clock className="w-4 h-4 text-turf-500" /> Instant
                  Confirmation
                </span>
                <span className="flex items-center gap-2 flex-shrink-0">
                  <MapPin className="w-4 h-4 text-turf-500" /> Prime Location in
                  Bhayli
                </span>
              </div>
            </div>
            <div className="hidden md:flex gap-8 md:gap-16 opacity-80 overflow-x-auto no-scrollbar whitespace-nowrap mask-linear-fade">
              <span className="flex items-center gap-2 flex-shrink-0">
                <Trophy className="w-4 h-4 text-turf-500" /> Tournament Grade
                Turf
              </span>
              ...
              <span className="flex items-center gap-2 flex-shrink-0">
                <Clock className="w-4 h-4 text-turf-500" /> Instant Confirmation
              </span>
              <span className="flex items-center gap-2 flex-shrink-0">
                <MapPin className="w-4 h-4 text-turf-500" /> Prime Location in
                Bhayli
      ...
      <div
        id="turfs-section"
        className="py-16 md:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
      >
            ...
            >
              <div className="relative h-[300px] md:h-[400px] overflow-hidden">
                ...
                <div className="absolute top-4 right-4 z-20 bg-black/60 backdrop-blur rounded-full px-4 py-2 border border-white/10">
                  <span className="text-turf-400 font-bold">
              ...
              <div className="absolute bottom-0 left-0 w-full p-6 md:p-8 z-20 bg-gradient-to-t from-black via-black/90 to-transparent">
                <div className="mb-4">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-2 group-hover:text-turf-400 transition-colors">
                    {turf.name}
                  </h3>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {turf.features.slice(0, 3).map((feature, i) => (
                    <span
                      key={i}
                      className="text-[10px] md:text-xs text-zinc-300 bg-white/10 px-3 py-1 rounded-full border border-white/5"
                    >
                      {feature}
                    </span>
                  ))}
      ...
      <div
        id="gallery-section"
        className="bg-zinc-950 py-16 md:py-20 border-y border-white/5"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <span className="text-turf-500 font-bold tracking-widest text-xs md:text-sm uppercase mb-2 block">
              Atmosphere
            </span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 md:auto-rows-[250px]">
            {GALLERY_IMAGES.map((img, i) => (
              <div
                key={img.id}
                className={`relative rounded-xl md:rounded-2xl overflow-hidden group border border-white/5 ${
                  i === 0 || i === 3
                    ? "col-span-2 row-span-2 md:col-span-2 md:row-span-2"
                    : "col-span-1 h-32 md:h-auto"
                }`}
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid md:grid-cols-3 gap-12 text-center relative">
          ...
          <div className="group">
            ...
            <p className="text-zinc-500 text-sm px-4 md:px-8">
              Choose your sport and pick a time that suits your squad.
            </p>
          </div>
          <div className="group">
            <div className="w-20 h-20 md:w-24 md:h-24 bg-zinc-900 rounded-2xl flex items-center justify-center mx-auto mb-6 md:mb-8 border border-zinc-800 group-hover:border-turf-500 transition-colors shadow-2xl relative z-10">
            ...
            <p className="text-zinc-500 text-sm px-4 md:px-8">
              Pay a small advance online to lock the turf instantly.
            </p>
          </div>
          <div className="group">
            <div className="w-20 h-20 md:w-24 md:h-24 bg-zinc-900 rounded-2xl flex items-center justify-center mx-auto mb-6 md:mb-8 border border-zinc-800 group-hover:border-turf-500 transition-colors shadow-2xl relative z-10">
            ...
            <p className="text-zinc-500 text-sm px-4 md:px-8">
              Show your booking ID at the venue and start playing.
            </p>
          </div>
        </div>
      </div>
